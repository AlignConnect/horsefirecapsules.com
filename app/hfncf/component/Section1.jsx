        ...
        <section className={noto.className}>
            <section className="w-full md:w-[600px] mx-auto px-3">
                ...
                <div>
                    ...
                    <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d8d729e7-981a-493f-749c-60fa9d37de00/public" width='100%' height='100%' alt="asd" loading='eager' fetchPriority="high" className="w-full" />
                    ...
                    <div className="">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/baef3259-cd75-449e-8072-0635bf5dc900/public" alt="asd" loading='eager' fetchPriority="high" className="w-full" width='100%' height='100%'/>
                    </div>
