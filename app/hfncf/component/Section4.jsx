            ...
            <div className="w-full md:w-[600px] mx-auto p-3">
                ...
                <div className='grid grid-cols-12 px-3 my-5'>
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/ab87c245-abbb-4fcc-795b-5a6ec343a900/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%' />
                        </div>
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d05e14f3-ca86-4119-7909-62aec31d7300/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%'/>
                        </div>
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/52ad0d23-89c8-4f87-0ca3-d48815b15300/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%'/>
                        </div>
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/e17dec5a-e4db-46bc-77be-5c02f7979b00/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%'/>
                        </div>
                        <p className="my-3">
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/e6e3e4d7-9647-4a00-a764-d0abc8356e00/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%' />
                        </div>
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/ecce7ff3-7a7f-422e-e5c5-1b23c0795300/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%'/>
                        </div>
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/038617f8-3c96-42c4-793c-aa9071511500/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%'/>
                        </div>
                    ...
                    <div className='col-span-6 font-bold text-center'>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/406ba916-2c07-43ad-2546-8665bd718700/public" alt="asdasd" loading='lazy' className="mx-auto" width='100%' height='100%'/>
                        </div>
                ...
                <section>
                    ...
                    <div className="">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/739179a6-593d-460b-ff10-106469e54500/public" alt="dff" loading="lazy" width='100%' height='100%' />
                    </div>
