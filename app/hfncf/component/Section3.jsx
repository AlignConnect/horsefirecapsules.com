        ...
        <section className={noto.className}>
            <section className="w-full md:w-[600px] mx-auto p-3">
                ...
                <div className="flex justify-center items-center gap-3 my-3 font-bold">
                    <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/5ee011aa-564b-435c-9297-5792a6038b00/public" alt="asdasd" loading="lazy" width={35} />
                    ...
                    <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/e5014d38-ab9a-4402-e7cf-9128be8e4f00/public" alt="asdasd" loading="lazy" width={35} />
                </div>
                ...
                <div className="grid grid-cols-12 mx-auto gap-3">
                    ...
                    <div className="col-span-6 md:col-span-6">
                        <div className="text-end flex items-center justify-end gap-3">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/9ca51ada-8750-4821-d90b-cec014d52d00/public" alt="dsfdsf" loading="lazy" width={60} className="w-[45px] md:w-[60px]" />
                            </div>
                        </div>
                    ...
                    <div className="col-span-6 md:col-span-6">
                        <div className="text-end flex items-center justify-end gap-3">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/2b24423c-446c-43b0-80b8-c8a08352fa00/public" alt="dsfdsf" loading="lazy" width={60} className="w-[45px] md:w-[60px]" />
                            </div>
                        </div>
                        <div className="bg-[#02c4ff] w-full min-h-[113px] flex items-center justify-center">
                    ...
                    <div className="col-span-6 md:col-span-6">
                        <div className="text-end flex items-center justify-end gap-3">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/c9f9224a-ec8d-4850-c334-5d224aaa1f00/public" alt="dsfdsf" loading="lazy" width={60} className="w-[45px] md:w-[60px]" />
                            </div>
                        </div>
                    ...
                    <div className="col-span-6 md:col-span-6">
                        <div className="text-end flex items-center justify-end gap-3">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b4aee8e2-368e-4996-988c-fc175f0d1e00/public" alt="dsfdsf" loading="lazy" width={60} className="w-[45px] md:w-[60px]" />
                            </div>
                        </div>
                ...
                <section className="text-center bg-[#d4d0cd] mt-5 px-5">
                    ...
                    <div className="md:w-[75%] ms-auto">
                        <div className="flex items-center gap-2 my-5">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/70212f71-ee6a-486f-391f-617712e95100/public" alt="ertyuiop" className="w-[30px]" />
                            </div>
                        ...
                        <div className="flex items-center gap-2 my-5">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/99d5441e-06a4-4961-097c-bffb444d7d00/public" alt="ertyuiop" className="w-[30px]" />
                            </div>
                        ...
                        <div className="flex items-unset md:items-center gap-2 mt-5">
                            ...
                            <div>
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/f1380151-d2dd-4411-08e6-f0a66de33100/public" alt="ertyuiop" className="w-[35px] md:w-[30px]" />
                            </div>
