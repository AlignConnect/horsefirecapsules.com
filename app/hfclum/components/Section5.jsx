...
const Section5 = () => {
    ...
    return (
        <div className='w-full my-5'>
            ...
            {/* 
            <h3 className='mt-3 text-center text-2xl sm:text-3xl font-bold'>क्या कहते है सेलिब्रिटी <br /><span className='text-red-700 uppercase'>Horse Fire Capsule</span><br /> के बारे में</h3>
