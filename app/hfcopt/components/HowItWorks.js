function HowItWorks() {
    ...
    const how_it_work_content = [
        {
            work_content: "प्रत्येक कैप्सूल शरीर में टेस्टोस्टेरोन हॉर्मोन और नाइट्रिक ऑक्साइड का उत्पादन करता है जिससे रक्त वाहिकाएं चौड़ी होती है।",
        ...
        <div>
            ...
            <div className="">
                <div className="bg-red-600 ">
                    <div className="max-w-3xl mx-auto relative mt-[5rem] md:mt-[13rem] ">
                        <div className={`flex flex-col text-md md:text-4xl items-end mr-4 uppercase text-white fontPoppins py-5`}>
                            <h1 className="font-bold"> Horsefire Capsule </h1>
