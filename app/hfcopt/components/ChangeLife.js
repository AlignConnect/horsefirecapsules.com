function ChangeLife() {
    ...
    const life_chagne_medicine = [
        {
            content: "Horse Fire Capsule का इस्तेमाल करने के बाद मिनट या 2 मिनट के अंदर डिस्चार्ज होने वाले पुरुष भी घंटो सेक्स का लुत्फ़ उठाने लगते है।",
        ...
        <div>
            <div>
                ...
                {life_chagne_medicine.map((e, key) => {
                    return <div className="mt-4  grid sm:grid-cols-2 grid-cols-1 gif_background gap-1 items-center md:gap-0" key={key}>
