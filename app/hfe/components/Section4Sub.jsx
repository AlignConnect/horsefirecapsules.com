...
const FlipFlip = dynamic(() => import('./FlipFlip'));
        ...
        <div className="w-full font-bold">
            <div className="relative ">
                <div className="relative z-10 px-5 py-8 grid gap-5 sm:gap-16">
                    ...
                    <h1 className="text-2xl sm:text-3xl border-2 text-yellow-400 border-white sm:w-11/12 text-center px-6 pt-5 pb-1 mx-auto leading-relaxed ">एक रिसर्च के अनुसार <span className="commonhft">Horse Fire Capsule</span> के इस्तेमाल से पुरुषों की सभी सेक्सुअल परेशानियां ठीक हो जाती हैं.</h1>
            ...
            <div className="pt-5 sm:py-5">
                ...
                <div className="px-5 ">
                    <h1 className="text-3xl sm:text-5xl text-center text-[#f91f20] ">Horse Fire Capsule <br /> <span className="text-yellow-400"> के फायदे</span></h1>
                </div>
