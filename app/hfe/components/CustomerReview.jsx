                ...
                return <div key={key}>
                    <div className="mx-2 my-5 p-2 rounded-md" style={{ boxShadow: "-1px 0px 5px 0px white" }} key={key}>
                        <div className='flex justify-start align-items-center gap-2 mb-2 mt-2'>
                            ...
                            <div>
                                <h5 className='mb-0 text-center align-center text-xl font-bold'>{e.name}&nbsp;<img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/c2e4d7c7-809a-4473-94e7-605bae769700/public" className='w-[18px] h-[18px] inline' alt="pic" loading='lazy' fetchPriority='low' decoding='async'
                                    loader={<p>wait</p>} /></h5>
