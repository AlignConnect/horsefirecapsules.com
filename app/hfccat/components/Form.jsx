...
const Form = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            formdata.append("post", "Horsefirecapsules.com/HFCCAT")
            formdata.append("ip", check ? check : "")
            formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
            formdata.append("blog_url", process.env.NEXT_APP_URL_HFCCAT ?? "horsefirecapsules.com/hfccat")
    ...
    return (
        <div id="form" className={noto.className}>
            ...
            <div className="bg-[url('https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0e4a1bdf-6c5d-4060-dd89-4a0ed191c800/public')] bg-cover">
                <div className=""
                >
