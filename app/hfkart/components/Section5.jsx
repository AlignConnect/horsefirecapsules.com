            ...
            <div className="max-w-4xl mx-auto  py-5 text-center md:pt-10 md:pb-5 relative ">
                ...
                <div className="relative z-10 ">
                    <a href="#form" className=""><img
                        src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6b516d08-cd28-4e07-bc68-d433a9337700/public"}
                        loading='lazy'
                        decoding="async"
                ...
                <Image src='https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/939639d0-1732-4d7c-c9cd-0f6d7590e000/public' fill alt="pic" className="absolute top-0 z-0 block md:hidden" />
            </div>
            ...
            <div className="w-full max-w-6xl mx-auto mt-5 md:mt-0">
                ...
                <div className="border-2 border-black py-2 px-2">
                    ...
                    <img
                        ...
                        src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/67aef5f8-6fc9-4b5e-765c-b10453c9f900/public"}
                        alt='expert_aword'
                        loading="lazy"
                    />
                ...
                <img
                    ...
                    src={"https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/7cb9294a-efc1-4a6e-e7f0-c98c4cc45c00/public"}
                    alt='expert_aword'
                    loading="lazy"
                />
            </div>
