...
const Section2 = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append("post", "Horsefirecapsules.com")
      formdata.append("ip", check ? check : "")
      formdata.append("checkout_toogle", checkoutDetail.checkoutChecked)
      formdata.append("blog_url", process.env.NEXT_APP_URL ?? "horsefireCapsules.com")
        ...
        <div className="max-w-5xl  overflow-hidden md:pt-[2rem] mx-auto pt-8 px-2">
          ...
          <div className="flex pb-5 justify-center items-center md:items-center flex-col md:mt-10 md:flex-row">
            <div className="pt-5 md:pt-0 w-full h-full">
              <CommonImg imglink="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/107c702d-279f-4408-96a6-a88bf3782f00/public" />
