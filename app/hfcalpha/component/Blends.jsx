...
const Blends = () => {
    return (
        ...
        <section className={noto.className}>
            <section className='bg-[url(https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0a7dd9a6-90e8-43fe-4e4b-0df4192d3a00/public)] bg-no-repeat bg-cover'>
            ...
            <section className="bg-[url('https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/185047b4-3a46-44bb-993e-d1e658091900/public')] pt-[40px] md:pt-[80px] pb-[20px]">
                ...
                <div className="flex flex-wrap justify-center items-center w-full md:w-[80%] mx-auto  gap-8">
                    ...
                    <div>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/8d572a15-da93-47a2-f329-58bbccdcc600/public" alt="erreer" loading="eager" className="rounded-full border-white border-2 w-[150px] md:w-[230px] min-h-[100px]" />
                        </div>
                    ...
                    <div>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/db316c2d-25d7-4aeb-5d58-4ce29cc48a00/public" alt="erreer" loading="eager" className="rounded-full border-white border-2 w-[150px] md:w-[230px] min-h-[100px]" />
                        </div>
                        <div className="text-2xl md:text-3xl text-center font-semibold py-3">
                    ...
                    <div>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/da0e8991-911f-4573-34d5-4b5808e99f00/public" alt="erreer" loading="eager" className="rounded-full border-white border-2 w-[150px] md:w-[230px] min-h-[100px]" />
                        </div>
                    ...
                    <div>
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/71e07afb-541e-4cf3-feab-8a0eab68b100/public" alt="erreer" loading='eager' className="rounded-full border-white border-2 w-[150px] md:w-[230px] min-h-[100px]" />
                        </div>
            ...
            <div className="bg-white">
                <div className='max-w-xl mx-auto'>
                    ...
                    {/* <div style={{ position: "relative", paddingTop: "56.25%" }}>
                        <iframe
                            src="https://customer-qp4u7i1mf8x9obux.cloudflarestream.com/cfd5ff6df31f2353140623e126c0da1c/iframe?poster=https%3A%2F%2Fcustomer-qp4u7i1mf8x9obux.cloudflarestream.com%2Fcfd5ff6df31f2353140623e126c0da1c%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600"
                            loading="lazy"
            ...
            <section className="md:py-[50px] bg-[url('https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/0751c7f8-5bf0-4215-9aa2-e6083fb64200/public')]">
                ...
                <section className="w-full md:w-[60%] px-1 mx-auto grid grid-cols-2 gap-5">
                    <div className="mx-auto my-5 flex flex-col md:flex-row items-center rounded-xl overflow-hidden col-span-2 md:col-span-1">
                        <div className="w-full md:w-[50%] h-full">
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/2d4dd761-27b9-440b-ac3d-957ff3a1c700/public" alt="asdrt" loading="lazy" className="w-full h-full min-h-[350px]" />
                        </div>
                    ...
                    <div className="mx-auto my-5 flex flex-col md:flex-row items-center rounded-xl overflow-hidden col-span-2 md:col-span-1">
                        <div className="w-full md:w-[50%] h-full">
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/247a70cc-f60d-47d9-819f-72f73136b100/public" alt="asdrt" loading="lazy" className="w-full h-full min-h-[350px]" />
                        </div>
                        <div className="bg-[#1c9ac3] w-full md:w-[50%] h-full p-3">
