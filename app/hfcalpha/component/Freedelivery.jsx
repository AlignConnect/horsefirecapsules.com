    ...
    <section className={`${noto.className} w-full bg-[#0d0d0d]`}>
      ...
      <section className="relative w-full md:w-[70rem] mx-auto min-h-[480px] md:min-h-[550px]">
        ...
        <div className="absolute w-[350px] bottom-0 md:w-full">
          <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/b0963bd5-e5ba-4aca-29ba-f8cf60925b00/public" alt="nofgg" loading="lazy" />
        </div>
        ...
        <div className="w-full md:w-[75%] flex flex-col md:flex-row justify-around items-center md:items-baseline ms-auto px-5">
          ...
          <div className="bg-white rounded-[30px] pb-[100px]">
            <ul className="text-3xl md:p-5 px-5">
              <li className="py-2 font-bold flex items-center gap-2"> <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/eac12091-69af-48b5-61c3-dea4b9afb100/public" loading="lazy" width={35} /> <span className="pt-4"> जंबो साइज लिंग      </span></li>
              <li className="py-2 font-bold flex items-center gap-2"> <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/eac12091-69af-48b5-61c3-dea4b9afb100/public" loading="lazy" width={35} /> <span className="pt-4"> ज्यादा सेक्स टाइमिंग   </span> </li>
              <li className="py-2 font-bold flex items-center gap-2"> <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/eac12091-69af-48b5-61c3-dea4b9afb100/public" loading="lazy" width={35} /> <span className="pt-4"> दमदार स्टैमिना      </span> </li>
              <li className="py-2 font-bold flex items-center gap-2"> <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/eac12091-69af-48b5-61c3-dea4b9afb100/public" loading="lazy" width={35} /> <span className="pt-4"> बेहतर सेक्स ऑर्गेज़्म </span>  </li>
            </ul>
          </div>
        </div>
