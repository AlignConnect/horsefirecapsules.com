            ...
            <div className="w-full md:w-[70rem] mx-auto py-6">
                ...
                <div className="w-[95%] md:w-[80%] my-[30px] mx-auto p-[10px] md:p-[40px] my-[40px] border grid grid-cols-2 items-center">
                    <div className="col-span-2 md:col-span-1">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/15f611bc-6837-40be-8818-c36d6affc400/public" alt="asdasd" loading="lazy" className="min-h-[400px]" />
                    </div>
                    <div className="col-span-2 md:col-span-1">
                ...
                <section className="grid grid-cols-2 items-center">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/f7bbc429-609c-4a40-bfd1-ae7b10f51800/public" alt="ddf" loading="lazy" className="w-[70%] min-h-[300px] md:w-[60%] mx-auto" />
                    </div>
