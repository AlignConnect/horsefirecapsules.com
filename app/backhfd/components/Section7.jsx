    ...
    return (
        <div className="w-full bg-hero3hfd bg-cover bg-no-repeat">
            <div className=" max-w-5xl px-2 mx-auto text-center py-6 md:py-10 text-black">
                ...
                <h1 className="text-[#d7751e] text-[1rem] md:text-2xl font-bold">"Horse Fire Capsule एक प्रूवेन फार्मूलेशन है। यह लैब टेस्टेड और आयुष मंत्रालय द्वारा प्रमाणित है जो सेक्स अवधि, शक्ति-स्फूर्ति और लिंग वृद्धि में मदद करता है!"
                </h1>
