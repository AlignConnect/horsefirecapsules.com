      ...
      <div className="max-w-5xl  m-auto ">
        <div className="bg-black px-3 py-2">
          <div className="flex  gap-3 items-center">
            ...
            <h1 className={`text-[1rem] w-11/12 md:text-2xl text-white ${poppin.className}`}>Horse Fire Capsule को सेक्स अवधि और लिंग वर्धक श्रेणी में आयुष मंत्रालय द्वारा प्रथम स्थान मिला है।</h1>
          </div>
        </div>
        ...
        <div className="px-3">
          ...
          <p className="text-xl md:text-2xl text-justify mt-10">ये ग्राफ दर्शा रहा है कि वियाग्रा को पुरुष पार्ट टाइम समाधान के रूप में इस्तेमाल कर रहे थे क्योंकि उनके पास कोई बेहतर विकल्प नहीं था। Horse fire Capsule का बढ़ता ग्राफ बताता है कि भारतीय पुरुषों ने इसे यौन समस्या के स्थाई समाधान के रूप में चुना और अपनी समस्या को हमेशा-हमेशा के लिए मिटा दिया।</p>
        </div>
      </div>
    </div>
  );
