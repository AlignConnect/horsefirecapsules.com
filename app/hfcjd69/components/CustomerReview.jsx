                    ...
                    <div className=" mx-2 my-5 p-2 rounded-md" style={{ boxShadow: " rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em" }} key={key}>
                        <div className='flex justify-start align-items-center gap-2 mb-2 mt-2'>
                            ...
                            <div className=''>
                                ...
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/685e3b62-0984-4c3d-8eac-6d2ffd034c00/public" alt="pic"  width='65px' height='100%'/>
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-[20rem] m-auto text-center">
                            {
                                key === 1 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/06ff6244-7678-4133-85d9-b32280c69200/public" alt="no" loading='lazy' className=' mx-auto py-2' width='250px' height='100%'/>
                            }
                            {

                                key === 3 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/daf47828-e8d3-4ad5-fa4a-9acb30d3cd00/public" alt="no" loading='lazy' className=' mx-auto py-2' width='250px' height='100%' />
                            }

                            {
                                key === 5 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/88eb9837-1ae0-423c-500c-712f26aa1a00/public" alt="no" loading='lazy' className=' mx-auto py-2' width='250px' height='100%'/>
                            }

                            {
                                key === 11 &&
                                <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/8ee11b42-966c-42cc-3a01-1c34fe950500/public" alt="no" loading='lazy' className=' mx-auto py-2' width='250px' height='100%'/>
                            }
