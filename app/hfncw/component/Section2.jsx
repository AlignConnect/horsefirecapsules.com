            ...
            <section className="w-full md:w-[600px] mx-auto px-3">
                ...
                <div className="grid grid-cols-12 mx-auto items-center my-5 gap-5">
                    ...
                    <div className="col-span-6">
                        ...
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/2e18b822-6d3d-46de-ab73-7141bfe47e00/public" alt="asd" loading='eager' fetchPriority="high" className="w-full" />
                        </div>
                    ...
                    <div className="col-span-6">
                        ...
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/836dd5a8-2441-4bfe-ef72-42b775ee4e00/public" alt="asd" loading='eager' fetchPriority="high" className="w-full" />
                        </div>
                        <p className="text-center text-md md:text-xl pt-3 font-bold">
                    ...
                    <div className="col-span-6">
                        ...
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d5f1163e-c50e-442a-9cfb-5cd42098e000/public" alt="asd" loading='eager' fetchPriority="high" className="w-full" />
                        </div>
                        <p className="text-center text-md md:text-xl pt-3 font-bold">
                    ...
                    <div className="col-span-6">
                        ...
                        <div>
                            <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/456eced1-658f-4a42-3e58-5bdc427e8f00/public" alt="asd" loading='eager' fetchPriority="high" className="w-full" />
                        </div>
                        <p className="text-center text-md md:text-xl pt-3 font-bold">
                ...
                <div className="bg-[#6a6b66] px-3 text-xl text-white">
                    ...
                    <div className="w-[95%] mx-auto py-3">
                        <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d6898b1b-8555-476f-4155-567d4af33700/public" alt="asd" loading='eager' fetchPriority="high" className="w-full" />
                    </div>
