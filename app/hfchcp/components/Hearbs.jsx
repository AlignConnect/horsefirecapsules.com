                    ...
                    <div className="sm:col-span-9">
                        ...
                        <div className="fontArya mt-[2.5vw] text-[1.16rem] text-justify sm:text-2xl lg:text-3xl font-bold leading-relaxed">
                            <div className="flex gap-3 sm:gap-5 ">
                               ...
                               <h1 className=""> <span className="text-red-600">17 जड़ीबूटियों और भस्मो से बने "Horse Fire Capsule"</span> से भारतीय पुरुषों का 3.5-4 इन्च छोटा और ढीला लिंग 8-9 इंच लम्बा और मोटा बन जाता है। जोश और स्टैमिना में अद्भुत बृद्धि होती है, हर वक़्त सेक्स की इच्छा जागृत रहती है।</h1>
                            </div>
