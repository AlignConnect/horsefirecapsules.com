...
function WhyChoose() {
    ...
    const revCus = [{
        ...
        comment: 'पहले मेरी पार्टनर को मेरे लिंग का असर ही नहीं होता था लेकिन Horse Fire Capsule खाने से अब मेरी लम्बाई और मोटाई में बृद्धि हो गयी है। अब आधा लिंग घुसाते ही वो सिसकारियां भरने लगती है। अब पूरा लेने से मना करती है और मुझे पीछे की तरफ धकेलती है। अब वो हर बार पानी-पानी हो जाती है, और संतुष्ट भी है।',
        name: 'दीपांकर',
        age: '26 साल'
    }, {
        image1: '/main/hf99_images/07.webp',
        image2: '/main/hf99_images/08.webp',
        comment: 'सचमुच, Horse Fire Capsule बेहतरीन यौन शक्तिवर्धक और लिंगवर्धक दवा है। यह सेक्स पावर को कई गुना बढ़ा देता है साथ ही लिंग साइज में भी सुधार करता है। इसके इस्तेमाल से मेरी शीघ्रपतन की कमजोरी जड़ से मिट गयी और लाइफ में सेक्स का मजा बढ़ गया है।',
        name: 'सम्राट',
        age: '29 साल'
    }]
