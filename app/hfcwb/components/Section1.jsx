        ...
        <div className='w-full'>
            <div className="px-3 sm:px-5 py-5 sm:py-10 text-[1rem] sm:text-xl text-center fontPoppins">
                <div className="bg-black fontArya text-white rounded-lg  ">
                    ...
                    <p className="p-3 sm:p-5 pt-2">ये सभी कामोत्तेजक जड़ीबूटियां वैज्ञानिक रूप से प्रमाणित है और Horse Fire CAPSULE भी आयुष मंत्रालय भारत सरकार द्वारा प्रमाणित उत्पाद है। </p>
                </div>
                ...
                <img src='/main/hf71_images/zinpro.webp' alt="pic" width='100%' height='100%' loading="lazy" className='mt-5 mb-3 sm:mt-8' />
                <OrderBtn/>
