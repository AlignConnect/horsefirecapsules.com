        ...
        <div className='w-full relative'>
            <div className=" relative z-10 py-10 text-center px-2 sm:px-5 ">
                <div className="fontPoppins font-bold">
                    <p className=" bg-red-600 px-10 outline-1 inline text-2xl sm:text-4xl text-white py-2 sm:py-1 -outline-offset-4 outline-dashed outline-white">HORSE FIRE CAPSULE</p>
