        ...
        <div className="bg-green-300">
            <div className='w-full relative'>
                <div className='relative z-10 px-3 text-center'>
                    ...
                    <h1 className=" sm:w-11/12 mx-auto bg-yellow-400 pt-3 pb-1 rounded-b-2xl text-xl sm:text-2xl font-bold ">Horse Fire CAPSULE के अद्भुत लाभ जो ग्राहक अनुभव करते है !</h1>
                    <div className="py-5 ">
