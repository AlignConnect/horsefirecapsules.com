            ...
            <div className='doctor_header_background'>
                <div className="w-full max-w-7xl text-center mx-auto ">
                    <div className="grid sm:grid-cols-2 items-center">
                        ...
                        <div className="">
                            <img src="/main/hft01doc_images/header_doctor.webp" alt="header_doctor" className="md:w-[95%] w-80 mx-auto pt-5" fetchPriority='high' loading='eager' />
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className='w-full max-w-7xl text-center mx-auto grid sm:grid-cols-3 '>
                    {
                        Delivery_Option([
                            {
                                delivery_icon: "/main/hft01doc_images/delivery.png",
                                delivery_title: "FREE SHIPPING",
                                delivery_content: " On all orders"
                            },
                            {
                                delivery_icon: "/main/hft01doc_images/percentage.png",
                                delivery_title: "OFFICIAL DISCOUNT",
                                delivery_content: "save big on next purchasing"
                            },
                            {
                                delivery_icon: "/main/hft01doc_images/customer.png",
