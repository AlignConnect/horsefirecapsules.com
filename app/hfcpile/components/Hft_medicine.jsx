...
function Hft_medicine() {
    return (
        <section>
            <div className="w-full max-w-7xl text-center mx-auto pb-5">
                ...
                <div className="grid sm:grid-cols-2 items-center  bg-[#deefff] mx-2">
                    ...
                    <div className="">
                        <img
                            src="/main/hft01doc_images/product_penis.webp"
                            alt="product_penis"
                ...
                <p className="text-black text-center fontNoto italic font-semibold text-[1.3rem] md:text-2xl sm:py-6 py-5 px-2 sm:px-60">
                    <span className="fontPoppins">Horse Fire Capsule</span> का नियमित सेवन करने पर पुरुष जोशीले बनने लगते है। पार्ट में लोहे के रॉड जैसी सख्ती मिलने लगती है जो घंटो तक बनी रहती है। टाइमिंग और स्टैमिना में जोरदार बढोत्तरी होती है जिससे कोई भी पुरुष नॉनस्टॉप प्रदर्शन कर सकता है।
                </p>
...
<OrderBtn/>
                ...
                {/* <div className="fontPoppins text-[#1e4389] sm:text-4xl text-3xl font-extrabold ">
                    Horsefire Capsule<span className="fontNoto"> पर ग्राहकों की प्रतिक्रिया </span>
                </div> */}


                {/* <p className="text-black text-center fontNoto text-[1.3rem] md:text-2xl sm:py-8 py-2 px-2 sm:px-60">
                    समस्या पर अपने सटीक असर की वजह से Horsefire Capsule ने ऑनलाइन मार्केट में धूम मचा दिया है। कमजोर पुरुष इसके मदद से जोश, स्टैमिना, टाइमिंग और कड़कपन बढ़ाकर असली मर्दानगी का अनुभव कर रहे है, ग्राहकों की प्रतिक्रिया आप खुद देख सकते है-
                </p> */}
