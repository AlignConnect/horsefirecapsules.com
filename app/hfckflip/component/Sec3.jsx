    ...
    return (
        <div className={noto.className}>
            ...
            <div className='bg-black text-white text-lg px-3'>
                ...
                <p>
                    अपनी पार्टनर को सेक्स में संतुष्टि देने और सेक्सुअल लाइफ में रोमांच भरने के लिए आज ही Horse Fire Capsule को अपने लाइफ का हिस्सा बनाये !
                </p>
            ...
            <div className='flex items-center sm:w-[500px] bg-white rounded-tl-2xl rounded-br-2xl py-4 mx-auto'>
                <div>
                    <img src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/647b0689-c18d-4a89-8675-7eebf7783500/public" alt="sdf" loading='lazy' className='w-[100%]' />
                </div>
