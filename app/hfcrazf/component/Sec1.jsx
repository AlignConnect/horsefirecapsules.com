          ...
          <div className="grid sm:grid-cols-2 items-center">
            ...
            <div className="px-4 sm:ps-[8%] sm:pe-0 py-5 sm:py-0">
              <p className="font-black text-2xl sm:text-5xl ">
                Get Ready for{" "}
                <span className="text-red-600">Sizzling Winter Nights</span>
              </p>

              <p className="mt-3 sm:mt-5 text-[1.1rem] sm:text-2xl ">अगर आप भी शीघ्रपतन, और कमजोर लिंग की वजह से सर्दी की रात को रोमांचक नहीं बना पा है तो <span className="font-bold">Horse Fire Capsule</span> आजमाकर इस साल सर्दी से पहले खुद को करें तैयार और बने धमाकेदार सेक्स करने के काबिल और कड़कड़ाती ठण्ड में भी हर रात पार्टनर को दें गर्मी का एहसास !</p>
            </div>
          </div>
        </div>
        <Image
