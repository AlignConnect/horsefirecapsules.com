...
const Form = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      formdata.append("post", "Horsefirecapsules.com/hfcrazf");
      formdata.append("ip", check ? check : "");
      formdata.append("checkout_toogle", checkoutDetail.checkoutChecked);
      formdata.append(
        "blog_url",
        process.env.NEXT_APP_URL_HFCRAZF ?? "horsefirecapsules.com/hfcrazf"
      );
      ...
      try {
        const form = await fetch(
          `https://horsefirecapsules.com/submitdata.php`,
