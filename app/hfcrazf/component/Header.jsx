    ...
    <div className="">
      <div className="hidden sm:block">
        <div className="relative">
          <img
            src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/d91de641-9f1d-46e9-7d79-dd4c6a932100/public"
            width="100%"
            height="100%"
            loading="lazy"
            fetchPriority="high"
          ...
          <div className="absolute z-10 -translate-x-1/2 -translate-y-1/2 top-[55%] lg:top-[65%] left-1/2 w-full h-full">
            <div className="px-3 grid grid-cols-2 align-middle ">
              <div className="ms-[10%] lg:ms-[25%]">
                ...
                <img
                  src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/6e1544e0-31ef-48a4-6d2e-39e38c651800/public"
                  width="70%"
                  height="100%"
                  loading="lazy"
                  fetchPriority="high"
      ...
      <div className="sm:hidden">
        <div className="relative ">
          <img
            src="https://imagedelivery.net/aacnHGAqlUDhaplA3bnkbA/a6b3bc39-b99d-4acf-7aea-3c3feed01300/public"
            width="100%"
            height="100%"
            loading="lazy"
            fetchPriority="high"
