...
function HowItsWork() {
    ...
    return (
        <div className='w-full'>
            <div className='max-w-5xl pt-5 sm:pt-10 mx-auto '>

                <div className="text-center fontPoppins font-bold">
                    <h1 className="inline-block  text-3xl  lg:text-6xl  leading-none bg-red-600 text-white px-5 py-2 ">HORSE FIRE CAPSULE</h1>
